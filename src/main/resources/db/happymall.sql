...
CREATE TABLE `mmall_order` (
  ...
  `shipping_id` int(11) NOT NULL COMMENT '购物车id',
...
CREATE TABLE `mmall_shipping` (
  ...
  `receiver_mobile` BIGINT(25) NOT NULL COMMENT '收货移动电话',
  ...
  `receiver_zip` INT(6) NOT NULL COMMENT '邮编',
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
